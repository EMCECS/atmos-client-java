...
import com.emc.vipr.transform.compression.LZMAOutputStream.LzmaProfile;
...
public class LZMAOutputStreamTest {
    ...
    public void testMemoryRequiredInt() {
        assertEquals(192937984, LZMAOutputStream.memoryRequired(5));
        assertEquals(771751936, LZMAOutputStream.memoryRequired(9));
    }
    ...
    public void testMemoryRequiredLzmaProfile() {
        assertEquals(0,
                LZMAOutputStream.memoryRequired(new LzmaProfile(0, 0, 0)));
        assertEquals(6174015488L,
                LZMAOutputStream.memoryRequired(new LzmaProfile(
                        512 * 1024 * 1024, 0, 0)));
    }
    ...
    private void runCompressMode(int i) throws IOException {
        ...
        long requiredMemory = LZMAOutputStream.memoryRequired(i);
    ...
    private LZMAOutputStream runCompressMode(LzmaProfile profile)
        ...
        long requiredMemory = LZMAOutputStream.memoryRequired(profile);
        System.out.println("Estimated memory usage: "
                + (requiredMemory / (1024 * 1024)) + "MB");

...
/**
 * <p>Java class for ResourceTagList complex type.
 * 
...
@XmlType(name = "ResourceTagList", propOrder = {
    "resources",
    "startIndex",
    "pageSize",
    "totalResults"
})
@XmlRootElement(name = "ResourceTagList")
...
public class ResourceTagList {
    ...
    public List<ResourceTag> getResources() {
        if (resources == null) {
            resources = new ArrayList<ResourceTag>();
        }

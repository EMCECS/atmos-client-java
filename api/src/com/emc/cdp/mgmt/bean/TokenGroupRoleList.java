...
/**
 * <p>Java class for TokenGroupRoleList complex type.
 * 
...
@XmlType(name = "TokenGroupRoleList", propOrder = {
    "tokenGroupRoles",
    "startIndex",
    "pageSize",
    "totalResults"
})
@XmlRootElement(name = "tokenGroupRoleList")
...
public class TokenGroupRoleList {
    ...
    @XmlElement(name = "tokenGroupRole", nillable = true)
    @Generated(value = "com.sun.tools.internal.xjc.Driver", date = "2012-05-23T11:11:22-05:00", comments = "JAXB RI v2.2.4")
     ...
     * This is why there is not a <CODE>set</CODE> method for the tokenGroupRoles property.
     * 
     * <p>
    ...
    public List<TokenGroupRole> getTokenGroupRoles() {
        if (tokenGroupRoles == null) {
            tokenGroupRoles = new ArrayList<TokenGroupRole>();
        }
        return this.tokenGroupRoles;
    }
